...
// 兼容旧版本
@property (nonatomic) CGFloat sd_left;
@property (nonatomic) CGFloat sd_top;
@property (nonatomic) CGFloat sd_right;
@property (nonatomic) CGFloat sd_bottom;
@property (nonatomic) CGFloat sd_centerX;
@property (nonatomic) CGFloat sd_centerY;
@property (nonatomic) CGFloat sd_width;
@property (nonatomic) CGFloat sd_height;
@property (nonatomic) CGPoint sd_origin;
@property (nonatomic) CGSize sd_size;
