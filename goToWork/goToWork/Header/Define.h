...
/// UIColor快捷创建
#define Default_BackgroundGray UIColorFromRGBx(0xF6F6F6)
...
#define APPMainColor HEXACOLOR(0x0d87ff)
#define PlaceHolderColor HEXACOLOR(0xcccccc)
...
#define OrderVCSelectIndexNOtiName @"OrderVCSelectIndexNOtiName"
