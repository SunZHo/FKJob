...
{
    return [[UIBarButtonItem alloc] initWithImage:[UIImage imageNamed:@"backIcon"]
...
- (NSArray *)viewControllers {
    ...
    WLGrapOrderPoolViewController *homeVC = [[WLGrapOrderPoolViewController alloc] init];
    homeVC.title = @"抢单池";
    UIViewController *firstNavigationController = [[CYLBaseNavigationController alloc]
                                                   initWithRootViewController:homeVC];
    
    WLOrderViewController *secondViewController = [[WLOrderViewController alloc] init];
    secondViewController.title = @"订单";
    UIViewController *secondNavigationController = [[CYLBaseNavigationController alloc]
                                                    initWithRootViewController:secondViewController];
    

    WLShopViewController *thirdViewController = [[WLShopViewController alloc] init];
    thirdViewController.title = @"店铺";
    UIViewController *thirdNavigationController = [[CYLBaseNavigationController alloc]
                                                   initWithRootViewController:thirdViewController];
    
    WLMyViewController *fourthViewController = [[WLMyViewController alloc] init];
...
//     tabBarController.tabBarHeight = 49.f;
    ...
    normalAttrs[NSForegroundColorAttributeName] = HEXACOLOR_a(0x0d87ff,0.7);
