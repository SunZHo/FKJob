...
//    UIColor *MainViewColor   = [UIColor colorWithRed:126/255.0 green:126/255.0 blue:126/255.0 alpha:1];
    ...
    // 设置导航栏默认的背景颜色
    [WRNavigationBar wr_setDefaultNavBarBarTintColor:APPMainColor];
    // 设置导航栏所有按钮的默认颜色
...
//    if ([viewController.childViewControllers[0] isKindOfClass:[WLMyViewController class]] && [LoginStatus integerValue] == 0) {
